...
<div class="container-fluid">
                    <h3 class="text-dark mb-4" style="padding-left: 400px;" >Profile</h3>
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="<?php echo BASE_URL ?>/assets/img/login1.jpg" width="160" height="160">
